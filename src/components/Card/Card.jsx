...
import stylecard from './Card.scss'
	...
	return (
        ...
        <div className='body'>
            ...
            <div class="card">
                ...
                <h4>Site 100% personnalisé</h4>
                <p>
                    Site de restauration , ecommerce , portfolio , nous nous adaptons à demande.
                </p>
                <div class="shine"></div>
            ...
            <div class="card">
                ...
                <p>
                Optimisez la performance et le rérérencement de votre site pour attirer + de clients.
                </p>
                <div class="shine"></div>
                <div class="background">
                <div class="tiles">
            ...
            <div class="card">
                ...
                <h4>Devis 100% gratuit</h4>
                <p>
                   Contactez nous , et obtenez un devis , votre projet web verra le jour au plus vite.                </p>
                <div class="shine"></div>
                <div class="background">
                <div class="tiles">
                    <div class="tile tile-1"></div>
